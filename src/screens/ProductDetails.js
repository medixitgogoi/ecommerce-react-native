                ...
                <View style={{ backgroundColor: "#fff", height: "100%", borderTopLeftRadius: 30, borderTopRightRadius: 30, paddingVertical: 25, paddingHorizontal: 15 }}>
                    ...
                    <View style={{ flexDirection: "column", justifyContent: "center", marginVertical: 15 }}>
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 8, justifyContent: "space-between" }}>
                            {colors.map(item => (
                                <TouchableOpacity key={item.id} style={{ width: 95, height: 120, borderColor: "#000", borderWidth: 0.6, justifyContent: "space-between", borderRadius: 8, overflow: "hidden" }}>
                                    <View style={{ justifyContent: "center", flexDirection: "row", alignItems: "center" }}>
                                        <Image source={require("../assets/shirt.png")} style={{ width: 80, height: 80 }} />
                                    </View>
                                    <View style={{ alignItems: "center", backgroundColor: "#e27e45", paddingVertical: 5 }}>
